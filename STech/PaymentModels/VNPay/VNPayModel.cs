...
namespace STech.PaymentModels.VNPay
{
    public class VNPayModel
    {
        ...
        public PaymentResponseModel GetFullResponseData(IQueryCollection collection, string hashSecret)
        {
            ...
            var checkSignature =
                vnPay.ValidateSignature(vnpSecureHash.ToString(), hashSecret); //check Signature
            if (!checkSignature)
