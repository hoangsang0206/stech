...
namespace STech.Utils
{
    ...
    {
        public static byte[] CreatePdf(IWebHostEnvironment env, Invoice invoice)
        {
            ...
            using (Document document = new Document(pdf))
            {
                ...
                .Add(new Paragraph(invoice.PaymentMed.PaymentName));
                ...
                List<InvoiceDetail> orderDetails = invoice.InvoiceDetails.ToList();
